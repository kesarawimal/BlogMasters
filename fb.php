...
FB.init({appId: '145653182750558', status: true, cookie: true,
xfbml: true});
};
(function() {
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-8">
                ...
                ?>
                <img src = "icon.png" id = "share_button">
                <!-- Comments Form -->
                <div class="well">
...
method: 'feed',
name: 'Blog Masters',
link: 'https://www.blogmasters.ml/post.php?post_id=124',
picture: 'https://www.blogmasters.ml/images/104300870-steve_jobs.1910x1000.jpg',
caption: 'How Steve Jobs Started',
